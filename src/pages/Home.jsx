  ...
  return (
    <div className="h-screen w-screen flex overflow-hidden">
      ...
      <button
        ...
        bg-white dark:bg-black/70 backdrop-blur border border-black/10 dark:border-white/10 transition-all duration-300
        ${sidebarOpen ? "left-[18rem]" : "left-4 md:left-[5.5rem]"}`}
      >
