...
${sidebarOpen ? "md:left-[288px] left-[48px]" : "left-[48px]"}
backdrop-blur-xl bg-black/70 border-b border-white/10 overflow-x-auto`}
>
...
>
  <Redo2 size={16}/>
      ...
      {/* A4 PAGE */}
<div
className={`absolute right-0 top-16 bottom-10 flex justify-center overflow-auto transition-all duration-300 p-2 md:p-0
${sidebarOpen ? "md:left-[288px] left-[48px]" : "left-[48px]"}`}
>


  <div className="
w-full max-w-[820px] min-h-[1120px]
bg-white/8
backdrop-blur-3xl
border border-white/20
rounded-2xl
shadow-[0_20px_80px_rgba(0,0,0,0.6)]
p-6 md:p-14 outline-none
text-white
leading-relaxed
caret-white
"
