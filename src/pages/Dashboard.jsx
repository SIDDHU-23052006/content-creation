...
const handleDownloadAnalysis = () => {
  ...
  return (
    <div
      className="min-h-screen text-gray-900 dark:text-white p-4 sm:p-6 md:p-10 bg-cover bg-center relative"
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto space-y-6 md:space-y-10">
...
<div>
  ...
  <span className="flex items-center gap-1 text-red-500">
    <TrendingDown size={16} /> Down
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between mt-8 md:mt-10 mb-4 gap-4 md:gap-0">
